...
document.querySelectorAll('.button').forEach(button => {
  button.addEventListener('click', function() {
    ...
    if (plan === 'daily') {
      document.body.style.backgroundImage = "url('home.webp')"; // Replace 'path_to_birthday_image.webp' with the actual path to your birthday background image
    } else if (plan === 'annual') {
      document.body.style.backgroundImage = "url('game.webp')"; // Replace 'path_to_corporate_image.webp' with the actual path to your corporate background image
    } else {
